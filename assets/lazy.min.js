...
*/
 ...
 SPDX-License-Identifier: Apache-2.0
*/
    var Oa = globalThis.trustedTypes, Pa;
    function Qa() {
        var a = null;
        if (!Oa)
            return a;
    ...
    ;
    var $a, ab = A("CLOSURE_FLAGS"), bb = ab && ab[748402147];
    $a = bb != null ? bb : !0;
    function cb() {
        var a = z.navigator;
    ...
    : function(a, b) {
      ...
      , eb = Array.prototype.forEach ? function(a, b) {
    ...
    }, yb = Object.defineProperties, C = nb ? pb : "internalArrayState", zb, Ab = [];
    E(Ab, 7);
    zb = Object.freeze(Ab);
    function Bb(a, b) {
        nb || C in a || yb(a, xb);
    ...
    ;var Db = {};
    function Eb(a, b) {
        return b === void 0 ? a.copyOnWrite !== Fb && !!(2 & (a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows[C] | 0)) : !!(2 & b) && a.copyOnWrite !== Fb
    }
    var Fb = {}
      , Gb = Object.freeze({});
    function Hb(a) {
    ...
    function Yb(a, b) {
        ...
        if (b <= 2097151)
            ...
            Cb() ? c = "" + (BigInt(b) << BigInt(32) | BigInt(a)) : (c = (a >>> 24 | b << 8) & 16777215,
            b = b >> 16 & 65535,
    ...
    function $b() {
        var a = G
          , b = H;
        b & 2147483648 ? Cb() ? a = "" + (BigInt(b | 0) << BigInt(32) | BigInt(a >>> 0)) : (b = w(Xb(a, b)),
        a = b.next().value,
        b = b.next().value,
        a = "-" + Yb(a, b)) : a = Yb(a, b);
        return a
    ...
    function wc(a) {
        ...
        if (a.length < 16)
            ...
            e += 6)
                ...
                H *= 1E6,
                G = G * 1E6 + d,
                G >= 4294967296 && (H += Math.trunc(G / 4294967296),
                H >>>= 0,
                G >>>= 0);
            b && (b = w(Xb(G, H)),
            a = b.next().value,
    ...
    function Ac(a, b, c) {
        ...
        d && (a = a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows,
    ...
    ;function Dc(a, b, c, d) {
        ...
        if (q)
            for (var D in q)
                a = q[D],
                a != null && (a = c(a, d)) != null && (h = +D,
                e = void 0,
                l && !Number.isNaN(h) && (e = h + n) < g ? f[e] = a : (h = void 0,
                ((h = b) != null ? h : b = {})[D] = a));
        b && (k ? f.push(b) : f[g] = b);
        return f
    }
    ...
    ;function Jc(a, b) {
        ...
        if (Array.isArray(a)) {
            var c = a[C] | 0;
            a.length === 0 && c & 1 ? a = void 0 : c & 2 || (!b || 4096 & c || 16 & c ? a = Kc(a, c, !1, b && !(c & 16)) : (Bb(a, 34),
            c & 4 && Object.freeze(a)));
            return a
        }
        if (a != null && a[vb] === Db)
            return b = a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows,
            c = b[C] | 0,
    ...
    function Lc(a, b, c) {
        return c & 2 ? !0 : c & 32 && !(c & 4096) ? (E(b, c | 2),
        a.copyOnWrite = Fb,
        !0) : !1
    }
    ;var Qc = F(0)
    ...
    function Wc(a, b, c, d, e) {
        ...
        d = Eb(a, g) ? 1 : d;
        e = !!e || d === 3;
        d === 2 && Nc(a) && (f = a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows,
        g = f[C] | 0);
        a = Sc(f, b);
        ...
        c = h;
        k = h = l;
        d === 1 || (d !== 4 ? 0 : 2 & h || !(16 & h) && 32 & g) ? Yc(h) || (h |= !c.length || a && !(4096 & h) || 32 & g && !(4096 & h || 16 & h) ? 2 : 256,
        h !== k && E(c, h),
        Object.freeze(c)) : (d === 2 && Yc(h) && (c = ec(c),
        k = 0,
        h = Xc(h, g),
        g = Uc(f, g, b, c)),
        Yc(h) || (e || (h |= 16),
    ...
    var L = function(a, b, c) {
        ...
        if (!Eb(a, e)) {
            ...
            f !== b && (Nc(a) && (d = a.internalArrayDoNotAccessOrElseMightBeUndefinedWhoKnows,
            e = d[C] | 0),
            b = f,
            e = Uc(d, e, c, b),
            Pc(d, e))
    ...
    Q.prototype.getExtension = function(a) {
        ...
        return a.ctor ? a.isRepeated ? a.getExtensionFn(this, a.ctor, a.fieldIndex, void 0 === Gb ? 2 : 4, a.hasMessageId) : a.getExtensionFn(this, a.ctor, a.fieldIndex, a.hasMessageId) : a.isRepeated ? a.getExtensionFn(this, a.fieldIndex, void 0 === Gb ? 2 : 4, a.hasMessageId) : a.getExtensionFn(this, a.fieldIndex, a.defaultValue, a.hasMessageId)
    }
    ;
    ...
    ;
    var ld = function(a) {
        return a instanceof kd && a.constructor === kd && a.STRING_CONST_TYPE_MARKER__GOOG_STRING_SECURITY_PRIVATE_ === jd ? a.stringConstValueWithSecurityContract__googStringSecurityPrivate_ : "type_error:Const"
    }
      , R = function(a) {
        return new kd(id,a)
    }
    ...
    ;var yd = function(a) {
      ...
      , Ad = function(a, b) {
        ed(b, function(c, d) {
            d == "style" ? a.style.cssText = c : d == "class" ? a.className = c : d == "for" ? a.htmlFor = c : zd.hasOwnProperty(d) ? a.setAttribute(zd[d], c) : d.lastIndexOf("aria-", 0) == 0 || d.lastIndexOf("data-", 0) == 0 ? a.setAttribute(d, c) : a[d] = c
        })
    }
      , zd = {
    ...
    ;
    var Kd, Ld = !1, Md = new Hd, Od = function(a, b) {
        Kd || Nd();
        Ld || (Kd(),
        Ld = !0);
        Md.add(a, b)
        ...
        if (a.state_ == 0)
            if (a.parent_) {
                ...
                if (c.callbackEntries_) {
                    for (var d = 0, e = null, f = null, g = c.callbackEntries_; g && (g.always || (d++,
                    g.child == a && (e = g),
                    !(e && d > 1))); g = g.next)
                        e || (f = g);
                    e && (c.state_ == 0 && d == 1 ? de(c, b) : (f ? (d = f,
...
*/
    ...
    V.prototype.cancel = function(a) {
        if (this.fired_)
            this.result_ instanceof V && this.result_.cancel();
        else {
            if (this.parent_) {
                var b = this.parent_;
                delete this.parent_;
                a ? b.cancel(a) : (b.branches_--,
                b.branches_ <= 0 && b.cancel())
            }
            this.onCancelFunction_ ? this.onCancelFunction_.call(this.defaultScope_, this) : this.silentlyCanceled_ = !0;
            this.fired_ || (a = new le(this),
            me(this),
            ne(this, !1, a))
        }
    }
      ...
      , oe = function(a) {
        if (a.unhandledErrorId_ && a.fired_ && te(a)) {
            var b = a.unhandledErrorId_
              , c = ue[b];
            c && (z.clearTimeout(c.id_),
            delete ue[b]);
            a.unhandledErrorId_ = 0
        }
        a.parent_ && (a.parent_.branches_--,
        delete a.parent_);
        b = a.result_;
        for (var d = c = !1; a.sequence_.length && !a.blocked_; ) {
            ...
            if (f = a.hadError_ ? g : f)
                try {
                    ...
                    h === se && (h = void 0);
                    h !== void 0 && (a.hadError_ = a.hadError_ && (h == b || h instanceof Error),
                    a.result_ = b = h);
        ...
        a.result_ = b;
        d && (h = La(a.continue_, a, !0),
        d = La(a.continue_, a, !1),
        b instanceof V ? (qe(b, h, d),
        b.blocking_ = !0) : b.then(h, d));
        c && (b = new ve(b),
        ue[b.id_] = b,
    ...
    var Ae = function() {
        ...
        e.onload = e.onreadystatechange = function() {
            e.readyState && e.readyState != "loaded" && e.readyState != "complete" || (xe(e, b.cleanupWhenDone || !1, h),
            g.callback(null))
        }
        ;
        e.onerror = function() {
    ...
    var Ce = function(a, b, c, d, e) {
      ...
      , De = function() {
        return A("gapi.load") ? Ge() : Ae().then(function() {
            return Ge()
        }, function(a) {
    ...
    W.prototype.getSeconds = function() {
        ...
        var b = Tc(this, 1);
        var c = typeof b;
        b = b == null ? b : c === "bigint" ? F(fc(64, b)) : mc(b) ? c === "string" ? tc(b) : uc(b) : void 0;
        return b != null ? b : a
    }
    ;
    ...
    Jf.prototype.init = function(a, b) {
        ...
        this.screenY = d.screenY || 0) : (this.offsetX = ib || a.offsetX !== void 0 ? a.offsetX : a.layerX,
    ...
    Sf.prototype.add = function(a, b, c, d, e) {
        ...
        var g = Tf(a, b, d, e);
        g > -1 ? (b = a[g],
        c || (b.callOnce = !1)) : (b = new Qf(b,this.src,f,!!d,e),
        b.callOnce = c,
        a.push(b));
        return b
    }
    ...
    var Uf = function(a, b) {
        var c = b.type;
        c in a.listeners && gb(a.listeners[c], b) && (Rf(b),
    ...
    var Vf = "closure_lm_" + (Math.random() * 1E6 | 0)
      ...
      , Yf = function(a, b, c, d, e) {
        if (Array.isArray(b))
            ...
            c = $f(c),
            a && a[Of] ? a.eventTargetListeners_.add(String(b), c, !0, Ia(d) ? !!d.capture : !!d, e) : ag(a, b, c, !0, d, e)
    }
      , fg = function(a, b, c, d, e) {
        if (Array.isArray(b))
            ...
            d = Ia(d) ? !!d.capture : !!d,
            c = $f(c),
            a && a[Of] ? a.eventTargetListeners_.remove(String(b), c, d, e) : a && (a = bg(a)) && (b = a.getListener(b, c, d, e)) && gg(b)
    }
      , gg = function(a) {
    ...
    m.send = function(a, b, c, d) {
        ...
        this.progressEventsEnabled_ && "onprogress"in this.xhr_ && (this.xhr_.onprogress = T(La(function(g) {
        ...
        !(db(og, b) >= 0) || d || e || c.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
        b = w(c);
        ...
        try {
            this.timeoutId_ && (clearTimeout(this.timeoutId_),
            this.timeoutId_ = null),
            this.timeoutInterval_ > 0 && (this.timeoutId_ = setTimeout(this.timeout_.bind(this), this.timeoutInterval_)),
            this.inSend_ = !0,
            this.xhr_.send(a),
            this.inSend_ = !1
        } catch (g) {
    ...
    ;
    m.timeout_ = function() {
        typeof Da != "undefined" && this.xhr_ && (this.dispatchEvent("timeout"),
        this.abort(8))
    }
    ;
    m.error_ = function() {
    ...
    var vg = function(a, b) {
      ...
      , sg = function(a, b) {
        if (a.xhr_) {
            a.timeoutId_ && (clearTimeout(a.timeoutId_),
            a.timeoutId_ = null);
            var c = a.xhr_;
            a.xhr_ = null;
    ...
    function Ag(a, b, c, d) {
        ...
        h && g !== 1 ? h = void 0 : g !== 1 || h && !N(f, 5) || (g = 0,
        h = void 0);
        k && g !== 2 ? g = 2 : g !== 2 || k && !a.anchor || (g = 0,
        k = void 0);
        ...
        a.helpPanelTheme === 2 && (O = c.matchMedia && c.matchMedia("(prefers-color-scheme: dark)").matches ? 1 : 0);
    ...
    ;for (var Bg = {
        ...
        "sr-latn": ["sh"],
        "fr-ca": ["fr-ca"]
    }, Cg = {}, Dg = w(Object.keys(Bg)), Eg = Dg.next(); !Eg.done; Eg = Dg.next()) {
        var Fg = Eg.value;
        Cg[Fg] = Fg;
    ...
    function bh() {
        ...
        function c(q, r) {
            if (typeof q === "string") {
                ...
                for (var p = [], v = 0, D = q.length; v < D; ++v)
    ...
    m.set = function(a, b, c) {
        ...
        h === void 0 && (h = -1);
        this.document_.cookie = a + "=" + b + (f ? ";domain=" + f : "") + (g ? ";path=" + g : "") + (h < 0 ? "" : h == 0 ? ";expires=" + (new Date(1970,1,1)).toUTCString() : ";expires=" + (new Date(Date.now() + h * 1E3)).toUTCString()) + (d ? ";secure" : "") + (e != null ? ";samesite=" + e : "")
    }
    ;
    m.get = function(a, b) {
    ...
    ;
    m.clear = function() {
        for (var a = gh(this).keys, b = a.length - 1; b >= 0; b--)
            this.remove(a[b])
    }
    ;
    var gh = function(a) {
    ...
    function rh(a, b) {
        ...
        var f;
        return (b == null ? 0 : (f = b.getEnableAlohaBinarySplit) == null ? 0 : f.call(b)) ? S(ph, a) : S(qh, a, d)
    }
    ;var sh = function() {
    ...
    function xh(a, b, c, d) {
        ...
        return th = b.feedbackV2GlobalObject ? Promise.resolve(b.feedbackV2GlobalObject) : new Promise(function(f, g) {
            ...
            ud(h, e);
            h.onload = function() {
                b.feedbackV2GlobalObject ? f(b.feedbackV2GlobalObject) : g(Error("feedbackV2GlobalObject not found on window."))
            }
            ;
            h.onerror = function() {
    ...
    function Ah(a, b, c, d) {
        ...
        return ya(function(h) {
            if (h.nextAddress == 1)
                return e = Date.now(),
                ra(h, yh(a, c, d.document, b), 2);
            if (h.nextAddress != 3)
                return f = h.yieldResult,
                ra(h, f.initializeFeedbackClientAsync(a, e, b, d), 3);
            g = h.yieldResult;
            g.initiateAloha();
            return h.return(g)
        })
    ...
    ;function Ch(a, b) {
        return ya(function(c) {
            return c.return(new Promise(function(d, e) {
                Number.isInteger(Number(a)) && Number(a) > 0 ? (e = Dh(b != null ? b : "") + "/aloha_form_properties?productId=" + a,
                qg(e, function(f) {
                    f = f.target;
                    var g = null;
                    try {
                    ...
                    d(g)
                }, "GET", "", {}, 2E3)) : e(Error("Invalid product id: " + a))
            }
            ))
        })
    }
      ...
      , Gh = function(a, b, c) {
        try {
            if (a.flow === "help") {
                ...
                a.flow === "submit" ? Eh(a, b, c) : Ch(a.productId, a.feedbackServerUri).then(function(e) {
                    e = L(e, jh, 1);
                    var f = !jb || (e == null ? void 0 : e.getEnableMweb())
                      , g = !a.tinyNoPointer || (e == null ? void 0 : e.getEnableTinyNoPointer());
                    !e || e.getAlohaAutoGaRollout() && f && g ? Fh(a, b, c, e).catch(function(h) {
    ...
    var Jh = /%{(\w+)}/g
      , Ih = RegExp("^((https:)?//[0-9a-z.:[\\]-]+/|/[^/\\\\]|[^:/\\\\%]+/|[^:/\\\\%]*[?#]|about:blank#)", "i");
    var Kh = function() {};
    ...
    m.delete = function(a) {
        a = Oh(a);
        return a in this.elements_ ? (delete this.elements_[a],
        !0) : !1
    }
    ;
    m.remove = function(a) {
    ...
    var Uh = function(a) {
        ...
        if (a instanceof Uh) {
            ...
            a && (b = String(a).match(lg)) ? (this.ignoreCase_ = !1,
            Vh(this, b[1] || "", !0),
            a = b[2] || "",
            Y(this),
            this.userInfo_ = Yh(a),
            ...
            a = b[7] || "",
            Y(this),
            this.fragment_ = Yh(a)) : (this.ignoreCase_ = !1,
    ...
    Uh.prototype.resolve = function(a) {
        ...
        c ? (Y(b),
        b.path_ = d) : c = a.queryData_.toString() !== "";
    ...
    var Vh = function(a, b, c) {
      ...
      , Xh = function(a, b, c) {
        Y(a);
        b instanceof Zh ? (a.queryData_ = b,
        a.queryData_.setIgnoreCase(a.ignoreCase_)) : (c || (b = $h(b, ei)),
    ...
    var Yh = function(a, b) {
      ...
      , $h = function(a, b, c) {
        return typeof a === "string" ? (a = encodeURI(a).replace(b, fi),
      ...
      , gi = function(a) {
        ...
        a.count_ = 0,
        a.encodedQuery_ && mg(a.encodedQuery_, function(b, c) {
    ...
    m.getValues = function(a) {
        ...
        var b = [];
        if (typeof a === "string")
            this.containsKey(a) && (b = b.concat(this.keyMap_.get(hi(this, a))));
        else {
    ...
    Zh.prototype.setIgnoreCase = function(a) {
        a && !this.ignoreCase_ && (gi(this),
        this.encodedQuery_ = null,
        this.keyMap_.forEach(function(b, c) {
            var d = c.toLowerCase();
            c != d && (this.remove(c),
            this.remove(d),
            b.length > 0 && (this.encodedQuery_ = null,
    ...
    function ii(a, b) {
        a = new Uh(a);
        return b === void 0 || b ? Vh(a, a.scheme_ || location.protocol).toString() : Vh(a, "http").toString()
    }
    ...
    var ni = x(["https://www.gstatic.com/uservoice/surveys/resources/", "/js/survey/survey_binary__", ".js"])
      ...
      , Z = function(a, b) {
        ...
        var d;
        (b = b.nonce || b.nonce) || (b = (d = this.window_) == null ? void 0 : d.document,
        b = td(b));
        this.nonce_ = b;
    ...
    m.updateContext = function(a) {
        var b = A("gapi.rpc");
        b && document.getElementById("help_panel_main_frame") !== null && (a || (a = A("document.location.href", window).substring(0, 1200)),
        b.setup(""),
    ...
    var ti = function(a, b) {
      ...
      , ui = function(a, b, c) {
        ...
        var Li = d.helpPanelMode
          ...
          , Ui = d.openingMode
          , Vi = d.minimizeMode
          , Wi = ((k = d.helpGuideOptions) == null ? 0 : k.helpGuideHelpCenterEmbedEntryPoint) ? si(d.helpGuideOptions.helpGuideHelpCenterEmbedEntryPoint) : void 0;
        k = ((l = d.helpGuideOptions) == null ? 0 : l.helpGuideCommonEmbedEntryPoint) ? si(d.helpGuideOptions.helpGuideCommonEmbedEntryPoint) : void 0;
        a: {
            var Kf;
            ...
            var Lf;
            Ed = ((Lf = d.helpGuideOptions) == null ? 0 : Lf.helpGuideStartingFlow) ? si(d.helpGuideOptions.helpGuideStartingFlow) : void 0
        }
        a: {
            var Mf;
            ...
            var Nf;
            Fd = ((Nf = d.helpGuideOptions) == null ? 0 : Nf.gseSessionOptions) ? si(d.helpGuideOptions.gseSessionOptions) : void 0
        }
        a = {
            anchor: q,
            channel: r,
        ...
        if (a.surveyData) {
            ...
            if (d) {
                ...
                d) {
                    ...
                    c = !0;
                if (c)
                    if (a.parentDomElementId != void 0 && a.parentDomElementId != "" && document.getElementById(a.parentDomElementId) == null)
                        a.listener && a.listener.surveyPrompted && a.listener.surveyPrompted(a.surveyData, {
                        ...
                        f = "rtl" == (f || (e.currentStyle ? e.currentStyle.direction : null) || e.style && e.style.direction) ? "rtl" : "ltr";
    ...
    m.dismissSurvey = function(a) {
        window.hatsNextGlobalObject && window.hatsNextGlobalObject.dismissSurvey && window.hatsNextGlobalObject.dismissSurvey(a.surveyMetadata)
    }
    ;
    m.scheduleSurvey = function(a) {
        if (!vi(a.triggerId))
            throw Error("Invalid triggerId");
        wi(this, a, !0).then(function(b) {
            b({
                surveyData: null,
                triggerId: a.triggerId,
                surveyId: a.surveyIdForTestingMode,
    ...
    var Zi = function(a, b) {
        if (b.enableFeedback1pEndpoint && b.enableTestingMode)
            return a.surveyStartupConfig_ = Yg(new Xg, Tg(!0)),
        ...
        return Zi(a, b).then(function(d) {
            if (Sg(L(d, Rg, 1))) {
                ...
                var g = (new Jg).setPlatform(1).setLibraryVersionInt(438217234).setSupportedCapabilityList([1, 2])
                  , h = b.preferredSurveyLanguageList && b.preferredSurveyLanguageList.length > 0 ? b.preferredSurveyLanguageList : [a.locale_];
                h = (new Ug).setTriggerId(b.triggerId).setLanguageList(h).setTestingMode(!!b.enableTestingMode);
                b.surveyIdForTestingMode != "" && b.surveyIdForTestingMode != void 0 && b.enableTestingMode == 1 && h.setSurveyId(b.surveyIdForTestingMode);
                f = (new Zg).setTriggerContext(h).setClientContext((new Kg).setDeviceInfo(f).setLibraryInfo(g));
                c != "" && c != void 0 && c == 1 && f.setScheduledSurveyContext((new Pg).setIsScheduledSurvey(c));
                d = Ce(d, "POST", e, f, $g)
            } else
                d = aj(a, b, c);
            return d
      ...
      , $i = function(a, b) {
        ...
        var e = [];
        var f;
        (f = z.__SAPISID || z.__APISID || z.__3PSAPISID || z.__1PSAPISID || z.__OVERRIDE_SID) ? f = !0 : (typeof document !== "undefined" && (f = new fh,
        f = f.get("SAPISID") || f.get("APISID") || f.get("__Secure-3PAPISID") || f.get("__Secure-1PAPISID")),
        f = !!f);
        f && (f = (d = d.indexOf("https:") == 0 || d.indexOf("chrome-extension:") == 0 || d.indexOf("chrome-untrusted://new-tab-page") == 0 || d.indexOf("moz-extension:") == 0) ? z.__SAPISID : z.__APISID,
        f || typeof document === "undefined" || (f = new fh,
        f = f.get(d ? "SAPISID" : "APISID") || f.get("__Secure-3PAPISID")),
        (f = f ? dh(f, d ? "SAPISIDHASH" : "APISIDHASH", c) : null) && e.push(f),
        d && ((d = hh("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", c)) && e.push(d),
        (c = hh("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", c)) && e.push(c)));
        e = e.length == 0 ? null : e.join(" ");
        b.thirdPartyDomainSupportEnabled != void 0 && b.thirdPartyDomainSupportEnabled && (a.thirdPartyDomainSupportEnabled_ = !0,
        e = !1);
      ...
      , aj = function(a, b, c) {
        ...
        b.surveyIdForTestingMode != "" && b.surveyIdForTestingMode != void 0 && b.enableTestingMode == 1 && a.setSurveyId(b.surveyIdForTestingMode);
        b = (new Te).setTriggerContext(a).setClientContext((new Ke).setDeviceInfo(f).setLibraryInfo(g));
        c != "" && c != void 0 && c == 1 && b.setScheduledSurveyContext((new Pe).setIsScheduledSurvey(c));
      ...
      , Ai = function(a, b, c) {
        var d = c.nonProd ? "nonprod" : "prod"
          , e = c.language && Cg[c.language.toLowerCase()] ? Cg[c.language.toLowerCase()] : Cg[a.locale_.toLowerCase()];
        e = e && e.replace("-", "_");
        e === "fa" && (e = "en");
        var f = e ? encodeURI(e) : "en";
        b.enableReloadScriptWhenLanguageChanges && !bj("https://www.gstatic.com/uservoice/surveys/resources/" + d + "/js/survey/survey_binary__" + f + ".js") && cj();
        window.hatsNextGlobalObject ? dj(b, c) : (e = document.createElement("script"),
        d = S(ni, d, f),
        ud(e, d),
        ...
        ,
        e.onerror = function() {
            b.listener && b.listener.surveyPrompted && b.listener.surveyPrompted(c, {
      ...
      , dj = function(a, b) {
        a: {
            ...
            a.parentDomElementId != null && a.parentDomElementId != "" && (c += "_" + a.parentDomElementId);
            if (window.hatsNextGlobalObject && window.hatsNextGlobalObject[c]) {
                if (window.hatsNextGlobalObject[c] > b.triggerRequestTime) {
                    a.listener && a.listener.surveyPrompted && a.listener.surveyPrompted(b, {
            ...
            c > 864E5 ? (a.listener && a.listener.surveyPrompted && a.listener.surveyPrompted(b, {
      ...
      , zi = function() {
        document.querySelectorAll("link[rel=stylesheet]").forEach(function(a) {
            var b;
            (a == null ? 0 : (b = a.getAttribute("href")) == null ? 0 : b.match(qi)) && a.parentNode.removeChild(a)
        })
    }
      , si = function(a) {
        if (!a)
